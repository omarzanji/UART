...
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells <n_0_43_BUFG_inst_i_2>]]
...
set_property  -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { rx_serial }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
